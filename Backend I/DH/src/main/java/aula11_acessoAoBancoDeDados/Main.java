...
public class Main {
    ...
    private static final String sqlInsert2 = "INSERT INTO Animal(id,Nome,Tipo) VALUES (2,'Dog','Cachorro')";
    private static final String sqlInsert3 = "INSERT INTO Animal(id,Nome,Tipo) VALUES (3,'Cat','Gato')";
    private static final String sqlInsert4 = "INSERT INTO Animal(id,Nome,Tipo) VALUES (4,'Missy','Gato')";
    private static final String sqlInsert5 = "INSERT INTO Animal(id,Nome,Tipo) VALUES (5,'Musk','Cavalo')";
